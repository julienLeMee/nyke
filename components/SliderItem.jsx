...
export const SliderItem = ({ position, img, name}) => {
  return (
    <>
      <div className='relative mx-auto h-auto w-auto duration-300 my-8 p-4 inline-block group'>
        <Link href="/">
          ...
          <p className='opacity-0 group-hover:opacity-100 duration-300 text-gray-500 tracking-wider py-4'>{name}</p>
        </Link>
      </div>
    </>
  )
