...
export const SliderItem = ({ position, img, name}) => {
  return (
    <>
      <div className='relative mx-auto h-auto w-auto duration-300 py-4 pr-4 inline-block group'>
        <Link href="/">
          ...
          <p className='opacity-0 group-hover:opacity-100 duration-300 text-2xl md:text-base text-black md:text-gray-500 pt-4'>{name}</p>
        </Link>
      </div>
    </>
  )
